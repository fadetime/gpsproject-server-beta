...
//白班主管添加司机收款客户
router.post('/editReceipt', dayShiftDriverMissionController.dayShiftDriver_editReceipt)

//白班司机完成客户收款
router.post('/finishReceipt', dayShiftDriverMissionController.dayShiftDriver_finishReceipt)
